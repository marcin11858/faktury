...
\comment{ TO DO usunac ten fragment: różnych dokumentow, jednym z nich jest
faktura, będąca potwierdzeniem konkretnej operacji. Taki dokument stanowi również cenne żródło informacji dla organów państwowych ponieważ określa kwotę należnego podatku, dokumentuje obrót przedsiębiorcy, a także pełni jeszcze inne funkcje.}
